#!/usr/bin/env python3
"""build_diag_rs10.py -- WHO tells the AED to show slot 1?
...
OUT = pathlib.Path("out/mainos_diag_rs10.bin")
...
def main():
    ...
    print(f"blob {len(blob)} B; logs every AED slot-setter call: caller, type, slot")
