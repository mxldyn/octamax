...
bp_ret:
    ...
    .align 2
twdis:  .byte 0x2c,0x87, 0x00,0x00, 0x00,0x00      | TDR = 0x00000000 (disable)
    .align 2
taatr:  .byte 0x2c,0x86, 0x00,0x00, 0x7f,0x00      | AATR = 0x00007F00 (match any write)
    .align 2
ten:    .byte 0x2c,0x87, 0x80,0x00, 0x20,0x04      | TDR = 0x80002004 (TRC=debug int, EBL+EAL)
    .align 2
ablrcmd: .byte 0x2c,0x8d, 0x00,0x00, 0x00,0x00     | ABLR (word0), operand filled at runtime
    .align 2
"""
